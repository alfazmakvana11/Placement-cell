...
//         return res.redirect("/dashboard"); // Update the URL as needed
//     } catch (err) {
//         console.log("error", "Error deleting interview!");
//         // Handle the error, perhaps by rendering an error page
//         return res.status(500).render("errorPage", { error: "Error deleting interview" });
//     }
// };